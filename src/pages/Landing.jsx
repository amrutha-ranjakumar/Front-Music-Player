  ...
  return (
    <>
      <div className='landing-background' style={{ backgroundSize: 'cover', backgroundPosition: 'center', minHeight: '100vh' }}>
        <div className='d-flex justify-content-center align-items-center' style={{ position: 'relative', height: '100%' }}>
          <Link to='./sign' style={{ textDecoration: 'none', color: 'white' }}>
            <button className='video-button' style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', border: 'none', background: 'transparent' }}>
              <img src={image1} alt='Button Image' className='img-fluid' style={{ maxWidth: '2400px' }} />
            </button>
          </Link>
      ...
      <Container className='d-flex align-items-center justify-content-evenly w-100 mt-5 p-4'>
        <Row>
          ...
          <Col md={6} className='d-flex flex-column align-items-center' >
            <img src='https://i.pinimg.com/564x/29/40/c9/2940c9a05ffecbe41b709ac24550209c.jpg' alt='' className='img-fluid mb-3' style={{borderRadius:"20%"}} />
          </Col>
        </Row>
      </Container>
      <Container className='d-flex align-items-center justify-content-evenly w-100 mt-5'>
        <Row>
