...
function Footer() {
  return (
    ...
    <div className='mb-5 p-5'  style={{marginTop:"1700px"}}>
    ...
    <div className='d-flex justify-content-center alig-items-center mt-5'>
      <div className='footer d-flex align-item-center justfy-content-evenly'>
        <div className='website'style={{width:"400px"}}>
         <Link to='/' style={{textDecoration:"none",color:"white",fontSize:"25px"}}><i class="fa-solid fa-video text-warning me-3"></i>Media Player</Link>
